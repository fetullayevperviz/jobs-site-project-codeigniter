...
<div class="card">
    ...
    <h5 class="card-title">İŞ GÜNÜ</h5>
    <a href="<?=base_url('admin/work_time_add');?>" class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Əlavə Et</a>
</div>  
  <div class="card-body">
      ...
      <tbody>
        <?php $num = 1; foreach ($info as $info): ?>
           <tr>
              ...
              <td class="text-center"><?=$info['work'];?></td>
              ...
              <td class="text-center">
                <a href="<?=base_url('admin/work_time_update/'.$info["id"].'');?>">
                  <button type="button" class="btn btn-success" name="button">Yenilə</button>
                <a href="<?=base_url('admin/work_time_delete/'.$info["id"].'/id/work_time');?>">
