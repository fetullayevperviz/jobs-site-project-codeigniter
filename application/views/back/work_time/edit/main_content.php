...
<div class="page-content fade-in-up">
    <div class="card card-info bg-dark text-white">
      <div class="card-header">
        <h3 class="card-title">İş Günü Yeniləmə Formu</h3>
      </div>
      <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?=base_url('admin/work_time_edit');?>">
        <div class="card-body">

          <div class="form-group row">
             <label class="col-sm-2 col-form-label">İş Günü</label>
             <div class="col-sm-10">
              <input class="form-control" type="text" name="work" value="<?=$info['work'];?>">
             </div>
          </div>
