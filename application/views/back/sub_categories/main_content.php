...
<div class="card">
    ...
    <h3 class="card-title">ALT KATEQORİYALAR</h3>
    <a href="<?=base_url('admin/sub_category_add');?>" class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Əlavə Et</a>
</div>  
  <div class="card-body">
      ...
      <tbody>
        <?php $num = 1; foreach ($info as $info): ?>
           <tr>
              ...
              <td class="text-center">
                <a href="<?=base_url('admin/sub_category_update/'.$info["id"].'');?>">
                  <button type="button" class="btn btn-success" name="button">Yenilə</button>
                <a href="<?=base_url('admin/sub_category_delete/'.$info["id"].'/id/sub_category');?>">
