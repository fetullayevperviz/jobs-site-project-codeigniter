...
<div class="card">
    ...
    <h5 class="card-title">TƏHSİL DƏRƏCƏLƏRİ</h5>
    <a href="<?=base_url('admin/edu_name_add');?>" class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Əlavə Et</a>
</div>  
  <div class="card-body">
    <table id="myTable" class="table table-bordered table-striped table-responsive">
      ...
      <tr>
        ...
        <th class="text-center">Təhsil Dərəcəsi</th>
      ...
      <tbody>
        <?php $num = 1; foreach ($info as $info): ?>
           <tr>
              ...
              <td class="text-center">
                <a href="<?=base_url('admin/edu_name_update/'.$info["id"].'');?>">
                  <button type="button" class="btn btn-success" name="button">Yenilə</button>
                <a href="<?=base_url('admin/edu_name_delete/'.$info["id"].'/id/education');?>">
