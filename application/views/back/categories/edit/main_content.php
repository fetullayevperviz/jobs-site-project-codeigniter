...
<div class="page-content fade-in-up">
    <div class="card card-info bg-dark text-white">
      <div class="card-header">
        <h3 class="card-title">Kateqoriya Yeniləmə Formu</h3>
      </div>
      <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?=base_url('admin/category_edit');?>">
        <div class="card-body">

          <div class="form-group row">
             <label class="col-sm-2 col-form-label">Kateqoriya adı</label>
             <div class="col-sm-10">
              <input class="form-control" type="text" name="cat_name" value="<?=$info['cat_name'];?>">
             </div>
          </div>
