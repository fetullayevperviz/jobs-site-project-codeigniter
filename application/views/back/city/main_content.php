...
<div class="card">
    ...
    <h5 class="card-title">ŞƏHƏRLƏR LİSTİ</h5>
    <a href="<?=base_url('admin/city_add');?>" class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Əlavə Et</a>
</div>  
  <div class="card-body">
      ...
      <tbody>
        <?php $num = 1; foreach ($info as $info): ?>
           <tr>
              ...
              <td class="text-center">
                <a href="<?=base_url('admin/city_update/'.$info["id"].'');?>">
                  <button type="button" class="btn btn-success" name="button">Yenilə</button>
                <a href="<?=base_url('admin/city_delete/'.$info["id"].'/id/city');?>">
